...
graph TD
    ...
    F --> G
    G --> H{Deposit 100,000 USDC}
    H -->|Republicans win universe| I[Trade RWin token pairs]
    H -->|Democrats lose universe| J[Trade RWin token pairs]
    I --> K[Redeem RWin token balances 1:1 to spot]
    J --> L[Test]
```
