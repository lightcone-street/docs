...
Once connected with a valid token, you can subscribe to your wallet's private stream by sending a subscription message:
...
### Forbidden (Wrong Wallet)

If you try to subscribe to a wallet you don't own:
...
```json
{
  ...
  "version": 0.1,
  "data": {
    "error": "Not authorized for this user stream",
    "code": "FORBIDDEN",
    "hint": "You can only subscribe to your own wallet addresses"
  }
}
```