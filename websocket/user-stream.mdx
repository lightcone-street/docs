...
- Global deposit pool balance updates
...
```json
{
  ...
  "data": {
    ...
    "global_deposits": [
      {
        "mint": "4o5Vsd7iPu97qkKypojXDbpu8BR3t5poD8ThGo8hnUKy",
        "balance": "1.50000000"
      }
    ],
    "nonce": 0
...
## Global Deposit Updates

When a user deposits to or withdraws from the global deposit pool, a `global_deposit_update` event is emitted with the new balance:
...
| `global_deposit_update` | - | Global deposit pool balance changed |
