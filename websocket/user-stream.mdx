...
To subscribe to the user stream, you must:
1. Connect with authentication (include `auth_token` cookie)
2. Subscribe to a wallet address that belongs to your authenticated account
...
<ParamField path="user" type="string" required>
  User's Solana wallet address (base58 encoded). Must be a wallet associated with your authenticated account.
</ParamField>
...
```json
{
  ...
  "data": {
    ...
    "balances": {
      "FjVJXzKknRoxgdQHNfdMkzq2vswGacM3MHiZhahczBsL:4o5Vsd7iPu97qkKypojXDbpu8BR3t5poD8ThGo8hnUKy": {
        "market_pubkey": "FjVJXzKknRoxgdQHNfdMkzq2vswGacM3MHiZhahczBsL",
