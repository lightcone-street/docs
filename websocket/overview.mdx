...
WebSocket connections are limited to **50 concurrent connections per IP address**. Exceeding this limit will return an error on connection attempt.
...
<CardGroup cols={2}>
  ...
  <Card title="Ticker" icon="bolt" href="/websocket/ticker">
    Event-driven best bid, best ask, and midpoint
  </Card>
</CardGroup>
